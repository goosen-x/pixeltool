...
const TOOLS: { title: string; description: string; path: string }[] = [
	...
	},
	{
		...
		description: 'Честный случайный выбор в диапазоне — для розыгрышей и решений.',
		path: 'random-number-generator'
	},
	{
		title: 'Рандомайзер команд',
		description: 'Разбивает список людей на равные команды или группы за один клик.',
		path: 'team-randomizer'
	},
	{
		title: 'Бросок костей',
		description: 'Виртуальные кубики для настольных игр — без физического набора под рукой.',
		path: 'dice-roller'
	},
	{
		title: 'Фавикон из картинки',
		description: 'Конвертирует PNG/JPG в favicon.ico нужных размеров одним архивом.',
		path: 'favicon-generator'
	},
	{
		title: 'Список эмодзи',
		description: 'Быстрый поиск и копирование эмодзи по названию или категории.',
		path: 'emoji-list'
	},
	{
		title: 'Проверка размера изображений',
		description: 'Узнать реальные размеры и вес картинки перед загрузкой на сайт.',
		path: 'image-size-checker'
	},
	{
		title: 'Таймер и секундомер',
		description: 'Обратный отсчёт или секундомер в браузере — без установки приложений.',
...
function run() {
	...
	ensureSpace(40)
	text(
		`Все инструменты: ${BASE_URL}/tools — «Всё нужное под рукой».`,
		11,
		{ color: [107, 114, 128] }
	)
