...
import { Copy, Download, Code, FileCode, AlertCircle, CheckCircle2 } from 'lucide-react'
...
export default function HtmlXmlParserPage() {
  ...
  const parseAndValidate = (content: string): { doc: Document | null; errors: string[] } => {
    const errors: string[] = []
          ...
          <CardContent>
            {result?.errors.length ? (
              <div className="mb-4 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                <p className="font-medium text-red-600 dark:text-red-400 mb-2">{t('errors')}:</p>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Select value={mode} onValueChange={(value) => setMode(value as ParseMode)}>
