				...
				<div className='rounded-lg overflow-hidden bg-[#f5f5f5] dark:bg-gray-800'>
					<div className='flex'>
						...
						<div className='flex-1 p-2 space-y-0.5'>
							<h3 className='font-semibold text-xs line-clamp-1'>{data.title}</h3>
							<p className='text-[10px] text-gray-600 dark:text-gray-400 line-clamp-2'>
								{data.description}
							</p>
			...
			<Card className='p-4'>
				<div className='flex flex-col lg:flex-row gap-6'>
					<div className='flex-1'>
						<Label htmlFor='url' className='text-sm font-medium'>{t('inputs.url')}</Label>
			...
			{validationResult && (
				<div className='space-y-4'>
					...
					{Object.keys(validationResult.foundTags).length > 0 && (
						<Card className='p-3'>
							<h3 className='font-semibold text-sm mb-2'>{t('results.foundTags')}</h3>
