...
export default function BMICalculatorPage() {
	...
	const bmiTips = [
		...
		},
		{
			...
			description:
				'Click "Show additional parameters" for body fat percentage calculation',
		...
		},
		{
			...
			description:
				"BMI doesn't distinguish between muscle and fat. Athletes may have high BMI despite low body fat",
						...
						<Card className='p-6'>
							...
							<div className='space-y-6'>
								...
								<div className='text-center'>
									...
									<Badge
										className={cn('text-lg px-3 py-1', result.categoryColor)}
									>
										{result.category}
									</Badge>
								</div>
									...
									<div className='space-y-2'>
										<div className='flex justify-between text-sm'>
											...
											<span className='font-medium'>
												...
												{result.idealWeight.max.toFixed(1)}{' '}
												{input.unitSystem === 'metric' ? 'кг' : 'lbs'}
											</span>
										</div>
								...
								<div className='p-3 bg-blue-50 dark:bg-blue-950/20 rounded-lg'>
									<div className='flex justify-between items-center'>
										...
										<span className='font-mono font-semibold'>
											{result.calories.maintenance} ккал
										</span>
									</div>
								</div>
								...
								{result.weightToLose > 0 && (
									<>
										<div className='p-3 bg-yellow-50 dark:bg-yellow-950/20 rounded-lg'>
											<div className='flex justify-between items-center'>
												<span className='text-sm'>
													Медленное похудение (-0.25 кг/нед)
												</span>
												<span className='font-mono font-semibold'>
													{result.calories.mildLoss} ккал
												</span>
											</div>
										</div>
										<div className='p-3 bg-blue-50 dark:bg-blue-950/20 rounded-lg'>
								...
								{result.weightToGain > 0 && (
									<>
										<div className='p-3 bg-green-50 dark:bg-green-950/20 rounded-lg'>
											<div className='flex justify-between items-center'>
												<span className='text-sm'>
													Медленный набор (+0.25 кг/нед)
												</span>
												<span className='font-mono font-semibold'>
													{result.calories.mildGain} ккал
												</span>
											</div>
										</div>
										<div className='p-3 bg-emerald-50 dark:bg-emerald-950/20 rounded-lg'>
											<div className='flex justify-between items-center'>
												<span className='text-sm'>
													Набор массы (+0.5 кг/нед)
												</span>
												<span className='font-mono font-semibold'>
													{result.calories.gain} ккал
												</span>
											</div>
										</div>
									</>
