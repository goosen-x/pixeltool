			...
			<Card className='p-6'>
				<div className='space-y-4'>
					...
					<p className='text-sm text-muted-foreground'>
						Enter any text to see it transformed into different fancy styles
						below
					</p>
				</div>
			</Card>
				...
				<TabsContent value='styles' className='space-y-4'>
					{inputText.trim() ? (
						<div className='space-y-3'>
							{generatedTexts.map(
								({ styleKey, styleName, text, description }) => (
									<Card
										key={styleKey}
						...
						<Card className='p-8'>
							<div className='text-center text-muted-foreground'>
								...
								<p className='text-sm'>
									Enter some text above to see it transformed into different
									fancy font styles.
								</p>
							</div>
						</Card>
						...
						<div className='space-y-6'>
							<div>
								...
								<p className='text-sm text-muted-foreground mt-2'>
									Adjust the intensity to control how chaotic the Zalgo text
									appears
								</p>
							</div>
							...
							{inputText.trim() ? (
								<div className='space-y-4'>
									...
									<div className='text-sm text-muted-foreground space-y-1'>
										<p>
											<strong>What is Zalgo text?</strong>
										</p>
										<p>
											Zalgo text is corrupted text that appears to be
											&ldquo;glitchy&rdquo; or &ldquo;cursed&rdquo; due to
											combining diacritical marks. It&apos;s often used for
											creative or horror-themed content.
										</p>
									</div>
								</div>
							) : (
			...
			<Card className='p-6 bg-muted/50'>
				...
				<div className='grid md:grid-cols-3 gap-6 text-sm'>
					...
					<div>
						...
						<ul className='text-muted-foreground space-y-1'>
							<li>
								• {Object.keys(generatedTexts).length || 12}+ different font
								styles
							</li>
