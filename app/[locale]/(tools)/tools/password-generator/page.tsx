...
export default function PasswordGeneratorPage() {
	...
	const shortcuts = [
		...
		},
		{
			...
			ctrl: true,
			action: () =>
				activeTab === 'random' ? generatePassword() : generatePassphrase(),
	...
	return (
		<WidgetLayout>
			...
			<WidgetOutput gradientFrom='from-primary/20' gradientTo='to-accent/20'>
										...
										>
											<div className='flex items-center justify-between'>
												...
												<div className='flex items-center gap-2'>
													<span
														className={`text-xs font-medium ${getStrengthColor(item.strength)}`}
													>
														{item.strength}%
													</span>
													<Button
