		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					Буквы алфавита нумеруются с нуля, а шифрование складывает номер буквы
					с ключом по кругу. «По кругу» здесь не метафора: после последней буквы
					счёт начинается заново с первой, поэтому в инструменте нарисован
				...
				/>
				{/* Диаграмма фиксированного сдвига (k=3) под формулой: та же
				    арифметика, но в виде стрелок между буквами — для тех, кому
				    проще прочитать mod по картинке, чем по индексам. bg-white
				    задан явно, а не через bg-muted/30, как у Formula: у самого
				    PNG непрозрачный белый фон, и на тёмной теме без этого он
				    оказался бы серым пятном с чёрными линиями поверх. Без
				    рамки — просто белая плашка, без ограничивающего контура. */}
				<div className='my-4 overflow-x-auto rounded-lg bg-white p-4'>
					<Image
						src='/images/tools/diagrams/caesar-cipher-shift-diagram.png'
						alt='Схема сдвига шифра Цезаря на 3 позиции: буквы верхнего ряда стрелками указывают на буквы нижнего ряда через три позиции по алфавиту'
						width={1815}
						height={472}
						className='mx-auto h-auto w-full max-w-2xl'
					/>
					<p className='mt-3 text-center text-sm text-muted-foreground'>
						Сдвиг 3: каждая буква переходит в ту, что стоит на три позиции
						дальше, а последние три буквы заворачивают в начало алфавита
					</p>
				</div>
				<p className='mt-3 text-muted-foreground'>
					Отсюда два следствия, которые видно на диске. Первое: сдвиг всегда
					можно привести к диапазону от 0 до n−1: сдвиг 30 по латинице это то же
					самое, что сдвиг 4, диск просто провернулся на лишний оборот. Второе:
					нулевой сдвиг оставляет текст как есть, поэтому осмысленных ключей на
					один меньше, чем букв.
				</p>
			</section>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					букву шифротекста и вычтите из её номера номер самой частой буквы
					языка, так вы получите ключ.
				</p>
				...
				<p className='mt-3 text-sm text-muted-foreground'>
					Русские частоты взяты по Национальному корпусу русского языка,
					английские по таблице из «Cryptological Mathematics» Роберта Лиуанда.
					Цифры округлены и заметно плывут на коротких текстах: на одной фразе
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					Почти всё, что называется «ROT-чем-то», это шифр Цезаря с закреплённым
					ключом. Общая идея одна: взять упорядоченный набор символов и
					провернуть его ровно на половину длины, чтобы шифрование и расшифровка
					стали одной и той же операцией.
				</p>
				<div className='mt-4 overflow-x-auto'>
					<table className='w-full text-left text-sm'>
						<thead>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					его по текстовому каналу, для этого есть другой инструмент,{' '}
					<Link
					...
					. А если нужен по-настоящему стойкий секрет, пригодится{' '}
					<Link
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					относительно друг друга. Идея оказалась живучей: в 1922 году армия США
					приняла на вооружение шифратор M-94 из 25 алюминиевых дисков на общей
					оси, и служил он до Второй мировой.
				</p>
				<p className='mt-3 text-muted-foreground'>
				...
				<p className='mt-3 text-muted-foreground'>
					Шифр Цезаря давно стал обычной остановкой в школьной программе и в
					квестах. Рядом с ним чаще всего оказывается{' '}
					<Link
