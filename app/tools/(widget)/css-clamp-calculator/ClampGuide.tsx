...
h1 {
  font-size: clamp(2rem, 1.5rem + 2vw, 4rem);
			...
			<p className='mt-3 leading-relaxed'>
				...
				знать саму формулу. Наклон — это разница размеров, делённая на разницу
				ширин экрана; свободный член — минимум минус наклон, умноженный на
				минимальную ширину.
			</p>
			<GuideCodeBlock
				className='mt-4'
...
наклон = (24 − 16) / (1200 − 320) = 0.00909  →  0.909vw
свободный член = 16 − 0.00909 × 320 = 13.09px  →  0.818rem
