		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					разберёт его без запуска, укажет строку и колонку, где споткнулся
					парсер. Поддерживается современный JavaScript (ES6/ES2020+) и JSX —
					то, что выполняется в браузере напрямую.
				</p>
			</section>
