		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					повторно складывает цифры результата. Поэтому в вашей матрице на
					другом сайте цифры вполне могут отличаться — это не ошибка ни у кого,
					а разница методик. Воспринимайте результат как повод для размышления о
					себе, а не как строгий факт.
				</p>
			</section>
