		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					числа), затем месяцы внутри незавершённого года, и, наконец, дни —
					тот же способ, каким возраст считают в паспортном столе или загсе.
				</p>
			</section>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					прошло с рождения целиком, сколько это полных месяцев, а также
					сколько дней осталось до следующего дня рождения. Дату можно
					посчитать не только на сегодня, но и на любой другой день — например,
					чтобы узнать точный возраст в день важного события.
				</p>
			</section>
		</div>
	)
