		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					таблицы, что и в калькуляторе бетона: состав смеси не зависит от того,
					во что её заливают. Для фундамента частного дома обычно берут М300.
					Числа — ориентир для закупки, а глубину заложения, сечение арматуры и
					марку для конкретного дома определяет проект: они зависят от грунта,
					глубины промерзания и нагрузки, которые калькулятор знать не может.
				</p>
			</section>
		</div>
	)
