		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					вес, а формат берётся из типа файла — без обращения к серверу. Поэтому
					подходит и для служебных скриншотов, и для клиентских макетов: файл
					остаётся на вашем устройстве. По той же причине можно закинуть сразу
					десяток файлов и выгрузить таблицу с результатами в CSV: ограничение
					только в производительности вашего компьютера.
				</p>
			</section>
		</div>
	)
