		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					изменившаяся внутри, — изменённой (жёлтый), причём жёлтым
					подсвечивается конкретное слово, а не вся строка целиком. Это точнее,
					чем простое «одинаково / не одинаково»: переставленная местами строка
					честно покажется как «удалили здесь — добавили там», а не
					проигнорируется. Сравнение считается прямо в браузере — тексты никуда
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					когда важен смысл, а не то, с какой буквы написано слово. Оба фильтра
					можно включать одновременно. Готовый результат забирается кнопкой
					скачивания в виде патча — обычного unified diff, который понимает Git
					и большинство редакторов кода.
				</p>
			</section>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					мешает увидеть, что реально поменялось в тексте договора, статьи или
					правки редактора.
				</p>
			</section>
