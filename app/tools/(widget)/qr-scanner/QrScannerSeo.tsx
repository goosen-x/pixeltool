		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					распознавания разбирает пиксели непрерывно, по кадрам через{' '}
					<code className='font-mono'>requestAnimationFrame</code>, без
					отдельной кнопки «сделать снимок». То же самое происходит и с
					загруженной картинкой: файл рисуется на том же canvas.
				</p>
			</section>
