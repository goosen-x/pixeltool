	...
	return (
		<section className='mt-12 max-w-3xl mx-auto text-left text-foreground'>
			...
			<p className='mt-3 leading-relaxed'>
				...
				элемента. По умолчанию в браузерах это 16px.
			</p>
			<GuideCodeBlock
				className='mt-4'
...
.a, .a .b, .a .b .c { font-size: 0.9rem; }  /* везде 14.4px */`}
			...
			<p className='mt-3 leading-relaxed'>
				...
				зависеть от текста рядом. Скажем, внутренний отступ кнопки, который сам
...
body { font-size: 1.6rem; } /* вернули читаемые 16px тексту */`}
			...
			<p className='mt-3 leading-relaxed'>
				...
				минимум, желаемое значение и максимум одной строкой, а собрать её можно
				в{' '}
				<Link
			...
			<p className='mt-8 leading-relaxed'>
				Про формулу перевода, трюк с базой 10px и то, почему rem важен для
				доступности, написано в статье{' '}
				<Link
