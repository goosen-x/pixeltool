	...
	return (
		<section className='mt-12 max-w-3xl mx-auto text-left text-foreground'>
			...
			<p className='mt-3 leading-relaxed'>
				...
				<strong>Меняйте светлоту, а не насыщенность.</strong> Затемните текст
				или осветлите фон, сохранив тон, — фирменный цвет останется узнаваемым,
				а коэффициент вырастет. Удобнее всего крутить это в HSL, где светлота
			...
			<ul className='mt-3 space-y-2 leading-relaxed'>
				...
				<li>
					...
					делают почти невидимой. Формально к ней требований нет, но
					пользователь должен понимать, что она вообще существует.
				</li>
				<li>
