		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					базовый обмен веществ — сколько калорий тело тратит в полном покое,
					только на дыхание, кровообращение и работу органов. Затем этот
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					универсальное распределение — 30% калорий из белка, 30% из жира,
					остальное из углеводов — подходящее для большинства целей без
					специализации под конкретный вид спорта.
				</p>
			</section>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					Формула — стандартный ориентировочный расчёт, не учитывающий приём
					лекарств, хронические заболевания, гормональные особенности и другие
					индивидуальные факторы. Для точного плана питания при особых условиях
					здоровья разумнее обратиться к врачу или диетологу, а не
					ориентироваться только на калькулятор.
				</p>
			</section>

			<p className='text-muted-foreground'>
				Разбор формулы на числовом примере, коэффициенты активности подробно и
				объяснение КБЖУ — в статье{' '}
				<Link
