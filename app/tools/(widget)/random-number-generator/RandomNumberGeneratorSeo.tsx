		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					Пронумеруйте участников по порядку (например, по номеру комментария) и
					зафиксируйте список до генерации. Задайте диапазон от 1 до числа
					участников — выпавшее число и есть номер победителя. Для розыгрыша
					сразу нескольких призов включите опцию «Уникальные»: тогда каждое
					число выпадет только один раз и один участник не выиграет два приза
					подряд.
				</p>
			</section>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					Стандартный генератор случайных чисел в JavaScript предсказуем: зная
					его текущее состояние, следующие значения можно вычислить заранее. Для
					розыгрыша с призом это уязвимость. Этот инструмент берёт числа из{' '}
