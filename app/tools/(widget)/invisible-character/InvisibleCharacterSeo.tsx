export function InvisibleCharacterSeo() {
	return (
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			{/* Раздел про названия — не ради плотности ключей. По выгрузке запросов
			    за 02–15.09.2026 «пустой символ» даёт 3890 показов, «пустой ник»
			    1188, «прозрачный символ» 1045 — вместе больше, чем головное
			    «невидимый символ» (5315). На странице этих слов не было вовсе, и
			    человек не понимал, что попал куда надо. */}
			<section>
				<h2 className='text-2xl font-bold tracking-tight'>
					Пустой, прозрачный, невидимый — это одно и то же
				</h2>
				<p className='mt-3 text-muted-foreground'>
					Одну и ту же вещь называют по-разному: пустой символ, прозрачный
					символ, невидимый знак, невидимый пробел. Ищут обычно пустой ник или
					невидимый ник — и имеют в виду ровно то, что на этой странице:
					юникод-символ, который можно скопировать и вставить как обычный текст,
					но который ничего не показывает.
				</p>
				<p className='mt-3 text-muted-foreground'>
					Единого «того самого» символа не существует, их несколько, и подходят
					они в разных местах по-разному — об этом ниже.
				</p>
			</section>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					У витрины скриншотов и иллюстраций в профиле Steam своё поле названия,
					отдельное от ника, и оно тоже принимает Hangul Filler. Уберите текст
					из заголовка иллюстрации и вставьте символ вместо него. Заголовок
					станет пустым, а сама картинка при этом останется на месте.
				</p>
			</section>
		</div>
	)
