		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					данные в поле выше — инструмент разберёт структуру и сразу покажет,
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					видом; размер отступа — 2, 4 пробела или таб — переключается в
					настройках. Обратная операция, сжатие (minify), убирает все лишние
					пробелы — это нужно, чтобы уменьшить объём перед отправкой на сервер.
				</p>
			</section>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					Проверьте данные здесь до того, как они уйдут в код, — так ошибку
					видно сразу, а не по логам продакшена.
				</p>
			</section>
			...
			<p className='text-muted-foreground'>
				Разбор синтаксиса с примерами — что такое ключи, массивы и вложенность,
				и чем JSON отличается от XML, — в статье{' '}
				<Link
