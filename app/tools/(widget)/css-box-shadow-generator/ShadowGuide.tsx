...
const PARAMS: { name: string; desc: string }[] = [
	...
	{
		name: 'offset-y',
		desc: 'Смещение по вертикали. Положительное значение опускает тень вниз, будто свет падает сверху.'
	},
	{
		name: 'blur-radius',
		desc: 'Размытие краёв. Ноль даёт резкую тень, большие значения дают мягкий рассеянный ореол.'
	},
	{
		name: 'spread-radius',
		desc: 'Растяжение, оно увеличивает или уменьшает тень целиком. Только у box-shadow.'
	},
	{
		name: 'color',
	...
	return (
		<section className='mt-12 max-w-3xl mx-auto text-left text-foreground'>
			...
			<p className='mt-3 leading-relaxed'>
				...
				скруглением углов. Тень букв рисует <Code>text-shadow</Code>, синтаксис
				у него короче, растяжения и внутренней тени нет вовсе. Генератор выше
...
text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);`}
			...
			<p className='mt-3 leading-relaxed'>
				...
				и вставьте в свой CSS или соберите собственный вариант в генераторе
				выше.
			</p>
			...
			<p className='mt-3 leading-relaxed'>
				...
				<Code>:hover</Code> и добавьте переход. Анимируйте только тень.{' '}
				<Code>margin</Code> и <Code>height</Code> не трогайте, иначе браузер
...
.card:hover {
  box-shadow: 0 8px 24px rgba(0, 0, 0, 0.15);
			...
			<p className='mt-3 leading-relaxed'>
				...
				, а полноценная анимация собирается в{' '}
				<Link
			...
			<p className='mt-3 leading-relaxed'>
				...
				рассеивается, поэтому берите <Code>rgba</Code> с альфой 0.08–0.15 и
				размытие 15–30px. Небольшое отрицательное растяжение подтягивает тень
				под элемент и убирает ореол по краям. Два-три слоя с разным размытием
				дают глубину, которой не добиться одним. Оттенок тени полезно брать не
				чёрный, а затемнённый цвет фона, подобрать его поможет{' '}
				<Link
			...
			<p className='mt-3 leading-relaxed'>
				...
				карточек и кнопок берите первое, для иконок и картинок с прозрачным
