		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					Open Graph: вы увидите картинку, заголовок и описание ровно так, как
					их отрисуют Telegram, ВКонтакте, Facebook и WhatsApp, — и успеете
					поправить теги до публикации.
				</p>
			</section>
