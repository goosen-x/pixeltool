		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					бытовым предметам, а не к десятичной логике. Отсюда и коэффициенты
					вроде «25,4» или «453,59237» — они не круглые, потому что изначально
					единицы возникли независимо друг от друга, а потом их просто
					договорились точно приравнять.
				</p>
			</section>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					сильнее накапливается погрешность. Этот конвертер считает по точным
