		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					нуля — формула просто не знает, что доля не может выйти за эти
					пределы. Интервал Уилсона устроен иначе и всегда остаётся в границах
					0–100%.
				</p>
				<p className='mt-3 text-muted-foreground'>
					Разница между вариантами считается отдельно, двухвыборочным z-тестом
					пропорций — тем же методом, что и хи-квадрат тест, на котором
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					Останавливать тест по первому «значимому» результату не стоит — лучше
					дождаться, пока выборка наберёт объём, достаточный для выбранного
					уровня доверия.
				</p>
			</section>
		</div>
