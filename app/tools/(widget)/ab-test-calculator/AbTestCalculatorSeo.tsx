		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					пропорций. Это тот же метод, что и хи-квадрат тест, на котором построены
					большинство калькуляторов A/B-тестов, включая калькулятор Эвана Миллера.
					При трёх и более вариантах калькулятор сравнивает их попарно и поднимает
					порог значимости поправкой Бонферрони. Чем больше пар проверяется, тем
					выше шанс найти «значимую» разницу просто по случайности, если не
					ужесточить критерий.
				</p>
			</section>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					Останавливать тест по первому «значимому» результату не стоит. Дождитесь,
					пока выборка наберёт объём, достаточный для выбранного уровня доверия.
				</p>
			</section>
		</div>
	)
