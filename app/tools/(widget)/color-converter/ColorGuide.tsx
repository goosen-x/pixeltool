...
const FORMATS: { name: string; desc: string }[] = [
	...
	{
		name: 'RGB / RGBA',
		desc: 'Каналы красного, зелёного, синего (0–255). A задаёт прозрачность (0–1). Модель экранов.'
	},
	{
		name: 'HSL / HSLA',
	...
	{
		name: 'LAB',
		desc: 'Перцептивная модель, расстояния в ней соответствуют видимой разнице. Для точного подбора и контраста.'
	}
]
...
export function ColorGuide() {
	return (
		<section className='mt-12 max-w-3xl mx-auto text-left text-foreground'>
			...
			<p className='mt-3 text-foreground leading-relaxed'>
				Один и тот же цвет в HEX, RGB и HSL.
			</p>
