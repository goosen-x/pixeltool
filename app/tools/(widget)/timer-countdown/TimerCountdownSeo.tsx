		...
		<div className='mx-auto mt-16 max-w-3xl space-y-12'>
			...
			<section>
				...
				<p className='mt-3 text-muted-foreground'>
					...
					Секундомер нужен для обратной задачи — когда неизвестно, сколько
					времени займёт действие, и его нужно замерить: пробежка, время ответа,
			...
			<p className='text-muted-foreground'>
				Подробный разбор техники Помодоро — зачем нужны перерывы, какие есть
				частые ошибки и как адаптировать классический цикл под себя — в статье{' '}
				<Link
