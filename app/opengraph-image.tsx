          ...
          >
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22" stroke="#3B82F6" strokeWidth="2"/>
                <path d="M2 12H22" stroke="#3B82F6" strokeWidth="2"/>
                <path d="M12 2C14.5013 4.73835 15.9228 8.29203 16 12C15.9228 15.708 14.5013 19.2616 12 22" stroke="#3B82F6" strokeWidth="2"/>
              </svg>
              100% Free
            </div>
          </div>
