...
export const ProjectsLeftSidebar = ({ onLinkClick }: Props = {}) => {
	...
	return (
		<aside className='w-64 lg:w-56 xl:w-64 h-[calc(100vh-var(--chrome-h,5rem))] lg:h-full shadow-[1px_0_8px_rgba(0,0,0,0.04)] bg-background lg:bg-muted/30 backdrop-blur-sm flex-shrink-0'>
