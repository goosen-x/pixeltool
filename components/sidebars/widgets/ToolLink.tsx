...
export const ToolLink = ({
	...
	>
		<Link
			href={href}
			onClick={onClick}
			// Сайдбар держит ссылки на все семьдесят тулов, и дефолтный prefetch
			// заказывал RSC-пейлоад каждой видимой: в трейсе PageSpeed это было
			// сорок запросов на 88 КБ, конкурирующих с критическим путём ради
			// перехода, которого в подавляющем большинстве сессий не будет.
			prefetch={false}
