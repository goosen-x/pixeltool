		...
		<Block className='col-span-12 row-span-2 md:col-span-8 relative overflow-hidden'>
			...
			<div className='relative z-10'>
				...
				<div className='mb-6'>
					<Badge
						variant='outline'
						className='gap-2 px-4 py-2 bg-background/80 backdrop-blur-sm border-primary/20'
					>
				...
				<div className='mb-8'>
					...
					<p className='text-lg text-muted-foreground max-w-lg leading-relaxed'>
						...
						technologies. Passionate about creating innovative solutions for web
						development.
					</p>
				</div>
				...
				<div className='flex flex-wrap gap-3 mb-8'>
					{[
						...
						<div
							key={idx}
							className='flex items-center gap-2 px-3 py-2 rounded-full bg-background/60 backdrop-blur-sm border border-border/50'
						>
							<div
								className={`p-1.5 rounded-full bg-gradient-to-r ${item.color}`}
							>
