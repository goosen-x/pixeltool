...
export function WidgetShareSection({
	...
	const shareData = {
		...
		description:
			widgetDescription || `${widgetTitle} - Free online tool for developers`,
		url,
		hashtags
	}
	...
	if (variant === 'inline') {
		return (
			<div className='flex items-center justify-between py-4 border-y'>
				...
				<SocialShareButtons data={shareData} variant='compact' />
			</div>
		)
	}
	...
	return (
		<Card className='p-6'>
			...
			<SocialShareButtons data={shareData} variant='default' />
