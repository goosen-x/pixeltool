...
interface SlidingCountdownProps {
  ...
  minutes: number
  seconds: number
  onTimeChange?: (field: 'hours' | 'minutes' | 'seconds', increment: boolean) => void
  isEditable?: boolean
  className?: string
}
...
export function SlidingCountdown({
  ...
  return (
    <div className={cn('flex items-center justify-center gap-4', className)} style={{fontFamily: 'ui-monospace, "SF Mono", "Monaco", "Inconsolata", "Fira Code", "Source Code Pro", monospace'}}>
      {/* Hours */}
      {isEditable ? (
      ...
      <span className='text-8xl md:text-9xl font-black tracking-wider tabular-nums text-muted-foreground/40' style={{fontFamily: 'ui-monospace, "SF Mono", "Monaco", "Inconsolata", "Fira Code", "Source Code Pro", monospace'}}>:</span>
