										...
										>
											<Card className="h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-border/50 bg-gradient-to-br from-background to-muted/10">
												<CardHeader>
													...
													<CardTitle className="text-lg font-heading transition-all duration-300 group-hover:text-primary">{project.title}</CardTitle>
												</CardHeader>
												<CardContent>
												...
												<CardContent className="p-5">
													<div className="flex items-center gap-4">
														...
														<div className="flex-1">
															<h3 className="font-heading font-semibold text-lg mb-1 transition-all duration-300 group-hover:text-primary">{project.title}</h3>
