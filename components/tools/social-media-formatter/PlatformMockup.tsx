...
export function PlatformMockup({ platform, text, className }: PlatformMockupProps) {
  ...
  if (platform === 'instagram') {
    return (
      <Card className={cn('max-w-sm bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800', className)}>
        {/* Header */}
  ...
  if (platform === 'facebook') {
    return (
      <Card className={cn('max-w-lg bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800', className)}>
        {/* Header */}
  ...
  if (platform === 'tiktok') {
    return (
      <Card className={cn('max-w-sm bg-black text-white border-gray-800', className)}>
