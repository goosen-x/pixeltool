      ...
      <div className="p-4 space-y-4">
        <div className="flex justify-between items-center min-h-[36px]">
          ...
          <Button 
            ...
            className={cn(
              ...
              hasRecentSymbols && selectedCategory === 'recent' ? "opacity-100" : "opacity-0 pointer-events-none"
            )}
          >
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2">
          ...
          >
            ...
            <span className="text-[11px] font-medium">{t('allCategories')}</span>
          </Button>
          ...
          {hasRecentSymbols && (
            ...
            >
              ...
              <span className="text-[11px] font-medium">{t('recentlyUsed')}</span>
            </Button>
          )}
          ...
          {symbolCategories.map(category => (
            <div key={category.id} className="relative">
              ...
              <Badge variant="secondary" className="absolute -top-1 -right-1 text-[10px] px-1 py-0 h-4 min-w-[20px] flex items-center justify-center">
