...
async function verifySupabaseSetup() {
  ...
  console.log('\n3️⃣ Table Status:')
  const tables = ['posts', 'widgets', 'widget_translations', 'widget_faqs', 'widget_analytics']
  ...
  console.log('2. If you have data in Neon, run: npx tsx lib/scripts/migrate-to-supabase.ts')
  console.log('3. Test the application: npm run dev')
  console.log('4. Check functionality: npx tsx lib/scripts/test-supabase-functionality.ts')
}
