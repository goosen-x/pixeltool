			...
			en: [
				{
					...
					answer:
						'This calculator handles 6 common percentage scenarios: finding X% of Y, finding the base number, finding 100%, calculating percentage change, and adding/subtracting percentages.'
				},
				{
					question: 'How do I calculate a discount?',
					answer:
						'Use the "Subtract %" tab. Enter the original price and the discount percentage to see the final price after discount.'
				},
				{
					question: 'How do I calculate tax?',
					answer:
						'Use the "Add %" tab. Enter the price and the tax percentage to see the total price including tax.'
				}
			],
			ru: [
				{
					...
					answer:
						'Этот калькулятор обрабатывает 6 распространённых сценариев с процентами: нахождение X% от Y, нахождение базового числа, нахождение 100%, расчёт процентного изменения и добавление/вычитание процентов.'
				},
				{
					question: 'Как рассчитать скидку?',
					answer:
						'Используйте вкладку "Вычесть %". Введите исходную цену и процент скидки, чтобы увидеть итоговую цену после скидки.'
				},
				{
					question: 'Как рассчитать налог?',
					answer:
						'Используйте вкладку "Добавить %". Введите цену и процент налога, чтобы увидеть общую цену с учётом налога.'
				}
			],
			he: [
				{
					...
					answer:
						'מחשבון זה מטפל ב-6 תרחישי אחוזים נפוצים: מציאת X% מ-Y, מציאת המספר הבסיסי, מציאת 100%, חישוב שינוי באחוזים והוספה/הפחתת אחוזים.'
				},
				{
					question: 'איך מחשבים הנחה?',
					answer:
						'השתמשו בכרטיסייה "הפחת %". הזינו את המחיר המקורי ואת אחוז ההנחה כדי לראות את המחיר הסופי אחרי ההנחה.'
				},
				{
					question: 'איך מחשבים מס?',
					answer:
						'השתמשו בכרטיסייה "הוסף %". הזינו את המחיר ואת אחוז המס כדי לראות את המחיר הכולל כולל מס.'
				}
			]
		}
	},
			...
			en: [
				{
					...
					answer:
						'Mailto: links only work if users have a local email client configured. Many users rely on web-based email, making mailto: links ineffective.'
				},
				{
					question: 'How does auto-copy work?',
					answer:
						'The generated links open a page that displays the email address and automatically copies it to the clipboard when clicked, providing better user experience.'
				},
				{
					question: 'Do these links work on mobile?',
					answer:
						"Yes! The auto-copy functionality works across all devices and doesn't depend on having email apps installed."
				},
				{
					question: 'Can I customize the link appearance?',
					answer:
						'Yes, you can set custom link text and title attributes. The generator creates clean HTML that you can style with CSS.'
				}
			],
			ru: [
				{
					...
					answer:
						'Ссылки mailto: работают только если у пользователей есть настроенный локальный почтовый клиент. Многие используют веб-почту, что делает mailto: ссылки неэффективными.'
				},
				{
					question: 'Как работает автокопирование?',
					answer:
						'Сгенерированные ссылки открывают страницу, которая показывает email-адрес и автоматически копирует его в буфер при клике, обеспечивая лучший UX.'
				},
				{
					question: 'Работают ли эти ссылки на мобильных?',
					answer:
						'Да! Функция автокопирования работает на всех устройствах и не зависит от установленных почтовых приложений.'
				},
				{
					question: 'Можно ли настроить внешний вид ссылки?',
					answer:
						'Да, можно задать произвольный текст ссылки и атрибуты title. Генератор создает чистый HTML, который можно стилизовать с помощью CSS.'
				}
			],
			he: [
				{
					...
					answer:
						'קישורי mailto: עובדים רק אם למשתמשים יש לקוח דואר מקומי מוגדר. משתמשים רבים מסתמכים על דואר מבוסס-ווב, מה שהופך קישורי mailto: לא יעילים.'
				},
				{
					question: 'איך עובד העתקה אוטומטית?',
					answer:
						'הקישורים שנוצרו פותחים דף המציג את כתובת האימייל ומעתיק אותה אוטומטית ללוח בעת לחיצה, מספק חוויית משתמש טובה יותר.'
				},
				{
					question: 'האם הקישורים עובדים במובייל?',
					answer:
						'כן! פונקציית ההעתקה האוטומטית עובדת על כל המכשירים ולא תלויה בהתקנת אפליקציות דואר.'
				},
				{
					question: 'האם אפשר להתאים את מראה הקישור?',
					answer:
						'כן, אפשר להגדיר טקסט קישור מותאם אישית ותכונות title. הגנרטור יוצר HTML נקי שאפשר לעצב עם CSS.'
				}
			]
		}
	},
			...
			en: [
				{
					...
					answer:
						'Celsius (°C) is used worldwide for daily temperatures and science, Fahrenheit (°F) is primarily used in the United States, and Kelvin (K) is the scientific standard starting from absolute zero (-273.15°C).'
				},
				{
					question: 'How do I remember the conversion formulas?',
					answer:
						'Key reference points: Water freezes at 0°C = 32°F = 273.15K, and boils at 100°C = 212°F = 373.15K. For quick estimates, °C to °F: multiply by 2 and add 30 (rough approximation).'
				},
				{
					question: 'What is absolute zero and why is Kelvin important?',
					answer:
						'Absolute zero (0K = -273.15°C = -459.67°F) is the theoretical temperature where all molecular motion stops. Kelvin is crucial for scientific calculations because it starts from this absolute minimum.'
				},
				{
					question: 'When should I use each temperature scale?',
					answer:
						"Use Celsius for daily weather, cooking, and most global contexts. Use Fahrenheit if you're in the US. Use Kelvin for scientific calculations, chemistry, and physics where absolute temperature matters."
				},
				{
					question: 'Are the conversions mathematically precise?',
					answer:
						'Yes, the converter uses exact formulas: C = (F-32)×5/9, F = C×9/5+32, K = C+273.15. All conversions are mathematically accurate to many decimal places for scientific precision.'
				}
			],
			ru: [
				{
					...
					answer:
						'Цельсий (°C) используется по всему миру для повседневных температур и в науке, Фаренгейт (°F) в основном используется в США, а Кельвин (K) - научный стандарт, начинающийся с абсолютного нуля (-273.15°C).'
				},
				{
					question: 'Как запомнить формулы преобразования?',
					answer:
						'Ключевые точки: вода замерзает при 0°C = 32°F = 273.15K, и кипит при 100°C = 212°F = 373.15K. Для быстрой оценки °C в °F: умножить на 2 и прибавить 30 (приблизительно).'
				},
				{
					question: 'Что такое абсолютный ноль и почему Кельвин важен?',
					answer:
						'Абсолютный ноль (0K = -273.15°C = -459.67°F) - это теоретическая температура, при которой прекращается всё молекулярное движение. Кельвин важен для научных расчетов, так как начинается с этого абсолютного минимума.'
				},
				{
					question: 'Когда следует использовать каждую температурную шкалу?',
					answer:
						'Используйте Цельсий для ежедневной погоды, готовки и большинства глобальных контекстов. Используйте Фаренгейт, если вы в США. Используйте Кельвин для научных расчетов, химии и физики, где важна абсолютная температура.'
				},
				{
					question: 'Математически ли точны преобразования?',
					answer:
						'Да, конвертер использует точные формулы: C = (F-32)×5/9, F = C×9/5+32, K = C+273.15. Все преобразования математически точны до многих десятичных знаков для научной точности.'
				}
			],
			he: []
		}
			...
			en: [
				{
					...
					answer:
						'This converter uses fixed exchange rates for demonstration purposes. For real-time rates, use a dedicated financial service. The rates are based on approximate values and should not be used for actual trading or financial decisions.'
				},
				{
					question: 'Which currencies are supported?',
					answer:
						'The converter supports 10 major world currencies: USD, EUR, GBP, JPY, CHF, CAD, AUD, CNY, INR, and RUB. These cover the most commonly traded currencies globally.'
				},
				{
					question: 'How accurate are the conversions for planning purposes?',
					answer:
						'The conversions use standard mathematical calculations and are accurate for the fixed rates provided. However, real exchange rates fluctuate constantly, so always check current rates for actual transactions.'
				},
				{
					question: 'Can I convert between any two currencies directly?',
					answer:
						'Yes! The converter allows direct conversion between any of the supported currencies. You can convert from any currency to any other without needing to go through a base currency like USD.'
				},
				{
					question:
						'What should I consider when planning international expenses?',
					answer:
						'Besides exchange rates, consider bank fees, credit card foreign transaction fees, and rate fluctuations over time. Use this tool for rough estimates, then check with your bank for actual costs.'
				}
			],
			ru: [
				{
					...
					answer:
						'Этот конвертер использует фиксированные обменные курсы в демонстрационных целях. Для получения актуальных курсов используйте специализированные финансовые сервисы. Курсы основаны на приблизительных значениях и не должны использоваться для реальных торговых или финансовых решений.'
				},
				{
					question: 'Какие валюты поддерживаются?',
					answer:
						'Конвертер поддерживает 10 основных мировых валют: USD, EUR, GBP, JPY, CHF, CAD, AUD, CNY, INR и RUB. Они охватывают наиболее часто торгуемые валюты в мире.'
				},
				{
					question: 'Насколько точны конверсии для целей планирования?',
					answer:
						'Конверсии используют стандартные математические расчеты и точны для предоставленных фиксированных курсов. Однако реальные обменные курсы постоянно колеблются, поэтому всегда проверяйте текущие курсы для фактических транзакций.'
				},
				{
					question:
						'Могу ли я напрямую конвертировать между любыми двумя валютами?',
					answer:
						'Да! Конвертер позволяет прямую конверсию между любыми поддерживаемыми валютами. Вы можете конвертировать из любой валюты в любую другую без необходимости использовать базовую валюту, такую как USD.'
				},
				{
					question:
						'Что следует учитывать при планировании международных расходов?',
					answer:
						'Помимо обменных курсов, учитывайте банковские комиссии, комиссии за валютные операции по кредитным картам и колебания курсов во времени. Используйте этот инструмент для приблизительных оценок, затем уточняйте фактические затраты в своем банке.'
				}
			],
			he: []
		}
			...
			en: [
				{
					...
					answer:
						'Compound interest is interest calculated on the initial principal plus all accumulated interest from previous periods. It grows exponentially because you earn interest on your interest, making it one of the most powerful wealth-building tools.'
				},
				{
					question: 'How accurate are the calculations?',
					answer:
						'The calculator uses precise financial formulas: A = P(1 + r/n)^(nt). Results are accurate for planning purposes, but real investments may vary due to market fluctuations, fees, and tax implications.'
				},
				{
					question:
						"What's the difference between annual and monthly compounding?",
					answer:
						'More frequent compounding means higher returns. Monthly compounding calculates interest 12 times per year versus once for annual, resulting in slightly higher total returns due to earning interest on interest more frequently.'
				},
				{
					question: 'Can I calculate the time needed to reach a goal?',
					answer:
						'Yes! Enter your target amount and the calculator will show you exactly how long it takes to reach your goal with different contribution amounts and interest rates, helping you plan your investment strategy.'
				},
				{
					question:
						'Should I focus on higher interest rates or regular contributions?',
					answer:
						'Both matter, but regular contributions often have more impact than chasing higher rates. Even small monthly additions can significantly boost your final amount due to the power of time and compounding.'
				}
			],
			ru: [
				{
					...
					answer:
						'Сложный процент - это проценты, начисляемые на первоначальную сумму плюс все накопленные проценты за предыдущие периоды. Он растет экспоненциально, поскольку вы зарабатываете проценты с процентов, что делает его одним из самых мощных инструментов накопления богатства.'
				},
				{
					question: 'Насколько точны расчеты?',
					answer:
						'Калькулятор использует точные финансовые формулы: A = P(1 + r/n)^(nt). Результаты точны для планирования, но реальные инвестиции могут отличаться из-за колебаний рынка, комиссий и налоговых последствий.'
				},
				{
					question:
						'В чем разница между годовым и месячным начислением процентов?',
					answer:
						'Более частое начисление означает более высокую доходность. Месячное начисление рассчитывает проценты 12 раз в год против одного раза при годовом, что приводит к немного более высокой общей доходности.'
				},
				{
					question:
						'Могу ли я рассчитать время, необходимое для достижения цели?',
					answer:
						'Да! Введите целевую сумму, и калькулятор покажет, сколько времени потребуется для достижения вашей цели с различными суммами взносов и процентными ставками, помогая планировать инвестиционную стратегию.'
				},
				{
					question:
						'Стоит ли сосредоточиться на более высоких процентных ставках или регулярных взносах?',
					answer:
						'Важно и то, и другое, но регулярные взносы часто оказывают большее влияние, чем погоня за высокими ставками. Даже небольшие ежемесячные добавления могут значительно увеличить итоговую сумму благодаря силе времени и сложного процента.'
				}
			],
			he: []
		}
			...
			en: [
				{
					...
					answer:
						'The calculator uses the standard loan payment formula: M = P[r(1+r)^n]/[(1+r)^n-1], where M is monthly payment, P is principal, r is monthly interest rate, and n is number of payments. This ensures accurate payment amounts.'
				},
				{
					question: 'What is an amortization schedule?',
					answer:
						'An amortization schedule shows how each payment is split between principal and interest over the life of the loan. Early payments have more interest, while later payments have more principal. This helps you see how equity builds over time.'
				},
				{
					question: 'Should I make extra payments on my loan?',
					answer:
						'Extra principal payments can significantly reduce total interest paid and loan term. However, consider your other debts and investments first - sometimes investing extra money elsewhere provides better returns than loan interest saved.'
				},
				{
					question: 'How does loan term affect my payments?',
					answer:
						'Longer terms mean lower monthly payments but more total interest paid. Shorter terms mean higher monthly payments but less total interest. Choose based on your budget and how long you want to be in debt.'
				},
				{
					question: 'What interest rate should I expect?',
					answer:
						'Interest rates vary based on credit score, loan type, market conditions, and down payment. Mortgages typically have lower rates than personal loans. Shop around with multiple lenders to find the best rate for your situation.'
				}
			],
			ru: [
				{
					...
					answer:
						'Калькулятор использует стандартную формулу расчета платежей по кредиту: M = P[r(1+r)^n]/[(1+r)^n-1], где M - ежемесячный платеж, P - основная сумма, r - месячная процентная ставка, n - количество платежей. Это обеспечивает точные суммы платежей.'
				},
				{
					question: 'Что такое график погашения?',
					answer:
						'График погашения показывает, как каждый платеж разделяется между основной суммой и процентами на протяжении всего срока кредита. Ранние платежи содержат больше процентов, поздние - больше основной суммы. Это помогает видеть, как накапливается собственный капитал.'
				},
				{
					question: 'Стоит ли делать дополнительные платежи по кредиту?',
					answer:
						'Дополнительные платежи по основной сумме могут значительно сократить общую сумму процентов и срок кредита. Однако сначала рассмотрите другие долги и инвестиции - иногда вложение дополнительных денег в другие активы дает лучшую доходность.'
				},
				{
					question: 'Как срок кредита влияет на мои платежи?',
					answer:
						'Более длительные сроки означают меньшие ежемесячные платежи, но больше общих процентов. Более короткие сроки означают большие ежемесячные платежи, но меньше общих процентов. Выбирайте исходя из своего бюджета и того, как долго вы хотите быть в долгах.'
				},
				{
					question: 'Какую процентную ставку мне ожидать?',
					answer:
						'Процентные ставки варьируются в зависимости от кредитного рейтинга, типа кредита, рыночных условий и первоначального взноса. Ипотека обычно имеет более низкие ставки, чем потребительские кредиты. Сравните предложения нескольких кредиторов.'
				}
			],
			he: []
		}
			...
			en: [
				{
					...
					answer:
						"Enter the distance you traveled and the amount of fuel used. The calculator will show consumption in liters per 100 km (L/100km) and miles per gallon (MPG), helping you monitor your vehicle's efficiency."
				},
				{
					question: "What's the difference between L/100km and MPG?",
					answer:
						'L/100km (liters per 100 kilometers) is the metric standard where lower numbers indicate better efficiency. MPG (miles per gallon) is used in the US/UK where higher numbers indicate better efficiency. Both measure fuel economy but in opposite scales.'
				},
				{
					question: 'How can I improve my fuel consumption?',
					answer:
						'Drive smoothly at consistent speeds, maintain proper tire pressure, remove excess weight, combine errands into one trip, and keep up with regular maintenance. Highway driving is typically more efficient than city driving.'
				},
				{
					question: 'Are the fuel cost calculations accurate?',
					answer:
						'Cost calculations are based on the fuel price you enter and are accurate for planning purposes. Actual costs may vary due to price fluctuations, different gas stations, and varying fuel grades.'
				},
				{
					question: 'Should I track fuel consumption regularly?',
					answer:
						'Yes! Regular tracking helps identify issues early (sudden increases may indicate mechanical problems), plan travel budgets, compare different routes, and monitor the effectiveness of fuel-saving techniques.'
				}
			],
			ru: [
				{
					...
					answer:
						'Введите пройденное расстояние и количество использованного топлива. Калькулятор покажет расход в литрах на 100 км (Л/100км) и милях на галлон (MPG), помогая контролировать эффективность вашего автомобиля.'
				},
				{
					question: 'В чем разница между Л/100км и MPG?',
					answer:
						'Л/100км (литры на 100 километров) - это метрическая система, где меньшие числа означают лучшую эффективность. MPG (мили на галлон) используется в США/Великобритании, где большие числа означают лучшую эффективность. Обе единицы измеряют экономичность топлива, но в противоположных шкалах.'
				},
				{
					question: 'Как я могу улучшить расход топлива?',
					answer:
						'Ездите плавно на постоянной скорости, поддерживайте правильное давление в шинах, убирайте лишний вес, объединяйте поездки, регулярно проводите техобслуживание. Езда по шоссе обычно более экономична, чем по городу.'
				},
				{
					question: 'Точны ли расчеты стоимости топлива?',
					answer:
						'Расчеты стоимости основаны на введенной вами цене топлива и точны для планирования. Фактические затраты могут варьироваться из-за колебаний цен, разных заправок и различных сортов топлива.'
				},
				{
