...
import { Disc3, Fingerprint, Key, Lock, QrCode, ScanQrCode } from 'lucide-react'
...
export const securityWidgets: Widget[] = [
	...
	},
	{
		...
		description:
			'Шифрование и расшифровка текста сдвигом по алфавиту — с наглядным шифровальным диском и перебором ключей',
		useCase:
		...
		faqs: [
			...
			},
			{
				...
				answer:
					'Перебрать все ключи. У шифра Цезаря их ровно на один меньше, чем букв в алфавите: 25 для латиницы и 32 для кириллицы. Включите «перебор ключей» — инструмент покажет все варианты сразу, осмысленный находится глазами за несколько секунд. Это и есть главная слабость шифра: ключей слишком мало, чтобы перебор был проблемой.'
			},
			{
				question: 'ROT13 — это шифр Цезаря?',
				answer:
