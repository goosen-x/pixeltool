...
export const textWidgets: Widget[] = [
		...
		},
	{
			...
			recommendedTools: ['text-counter', 'fancy-text-generator', 'special-symbols-picker'],
			difficulty: 'beginner',
			tags: [
				'text',
				'case',
		...
		},
	{
			...
			recommendedTools: ['special-symbols-picker', 'fancy-text-generator', 'text-emoticons'],
			difficulty: 'beginner',
		...
		},
	{
			...
			recommendedTools: ['emoji-list', 'special-symbols-picker', 'fancy-text-generator'],
			difficulty: 'beginner',
		...
		},
	{
			...
			recommendedTools: ['special-symbols-picker', 'fancy-text-generator', 'emoji-list'],
			difficulty: 'beginner',
		...
		},
	{
			...
			recommendedTools: ['text-to-speech', 'fancy-text-generator', 'text-case-converter'],
			difficulty: 'beginner',
