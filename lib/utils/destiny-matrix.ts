 ...
 * Единственный источник с полными формулами: gadalkindom.ru, раздел
 * «Полная методика» (формулы подтверждены дословным чтением исходной
 * страницы). Это одна
 ...
 * точка, родовой квадрат четвёртая-день) — как в первоисточнике
 * (gadalkindom.ru).
 */
