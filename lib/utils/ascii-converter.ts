...
export function textToAscii(text: string, font: 'standard' | 'small' | 'big' = 'standard'): string {
...
export function downloadAsciiAsImage(ascii: string, filename: string, options?: any) {
