...
export const createCalculatorShortcuts = (actions: CalculatorActions): KeyboardShortcut[] => [
  {
    key: 'Enter',
    ctrl: true,
...
export const createConverterShortcuts = (actions: ConverterActions): KeyboardShortcut[] => [
  {
    key: 'Enter',
    ctrl: true,
    description: 'Convert',
...
export const createGeneratorShortcuts = (actions: GeneratorActions): KeyboardShortcut[] => [
  {
    key: 'g',
    ctrl: true,
...
export const createEditorShortcuts = (actions: EditorActions): KeyboardShortcut[] => [
  ...(actions.format ? [{
    key: 'f',
    ctrl: true,
    shift: true,
