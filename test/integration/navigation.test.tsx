...
describe('Navigation', () => {
  it('renders main navigation links', () => {
    ...
    expect(screen.getByRole('link', { name: /Main/i })).toHaveAttribute('href', '/en')
    expect(screen.getByRole('link', { name: /Tools/i })).toHaveAttribute('href', '/en/tools')
    expect(screen.getByRole('link', { name: /Blog/i })).toHaveAttribute('href', '/en/blog')
