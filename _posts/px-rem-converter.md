...
- **Смешивание баз в разных компонентах.** Если часть вёрстки завязана на 16px,
  а часть — на изменённый `font-size` корня, одинаковый `rem` в разных местах
  даёт разный результат. База должна быть одна на весь проект.
