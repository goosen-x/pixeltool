...
Числа — это порядок величины при равномерном переборе всех комбинаций, а не
взлом конкретного алгоритма хеширования: реальная скорость атаки зависит от
того, чем и как захешированы пароли на сервере, который вы не контролируете. Но
масштаб понятен: лишний символ значит для времени перебора куда больше, чем ещё
один тип символов в алфавите.
