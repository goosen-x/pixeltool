...
Тот же принцип объясняет, почему самодельные шифры не защита. Классика жанра —
[шифр Цезаря](/tools/caesar-cipher), сдвиг каждой буквы алфавита на несколько
позиций: выглядит непонятно, а вариантов сдвига всего тридцать три, и
перебираются они мгновенно. Пароль, полученный превращением слова по любому
запоминаемому правилу, ломается так же — правило подбирается вместе с паролем.
