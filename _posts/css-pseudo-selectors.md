...
Стрелка у внешней ссылки выше — это текстовый символ в `content`, и он зависит
от шрифта: в одном начертании стрелка выглядит тонкой, в другом съезжает по
базовой линии. Предсказуемее подставить иконку картинкой — `content: ''` плюс
...
5. Помните о [производительности](/blog/lighthouse-100) при сложных селекторах
